...
"""autogenerated by genpy from action_remote_teleop/CountUntilActionResult.msg. Do not edit."""
import codecs
import sys
...
class CountUntilActionResult(genpy.Message):
  _md5sum = "82397ea6df7d25cc177e4875f81d5faa"
  _type = "action_remote_teleop/CountUntilActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_remote_teleop/CountUntilResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CountUntilActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_remote_teleop.msg.CountUntilResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_remote_teleop.msg.CountUntilResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.count,) = _get_struct_q().unpack(str[start:end])
      return self
