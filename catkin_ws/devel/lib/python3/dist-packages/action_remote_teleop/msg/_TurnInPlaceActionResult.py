...
"""autogenerated by genpy from action_remote_teleop/TurnInPlaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class TurnInPlaceActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "action_remote_teleop/TurnInPlaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_remote_teleop/TurnInPlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TurnInPlaceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_remote_teleop.msg.TurnInPlaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_remote_teleop.msg.TurnInPlaceResult()
