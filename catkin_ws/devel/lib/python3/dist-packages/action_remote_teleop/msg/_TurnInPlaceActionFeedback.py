...
"""autogenerated by genpy from action_remote_teleop/TurnInPlaceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TurnInPlaceActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "action_remote_teleop/TurnInPlaceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_remote_teleop/TurnInPlaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TurnInPlaceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action_remote_teleop.msg.TurnInPlaceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_remote_teleop.msg.TurnInPlaceFeedback()
