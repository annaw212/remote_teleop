...
(cl:defmethod cl:initialize-instance :after ((m <CountUntilGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CountUntilGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action_remote_teleop-msg:<CountUntilGoal> is deprecated: use action_remote_teleop-msg:CountUntilGoal instead.")))

(cl:ensure-generic-function 'max_number-val :lambda-list '(m))
(cl:defmethod max_number-val ((m <CountUntilGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_remote_teleop-msg:max_number-val is deprecated.  Use action_remote_teleop-msg:max_number instead.")
  (max_number m))

(cl:ensure-generic-function 'wait_duration-val :lambda-list '(m))
(cl:defmethod wait_duration-val ((m <CountUntilGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_remote_teleop-msg:wait_duration-val is deprecated.  Use action_remote_teleop-msg:wait_duration instead.")
  (wait_duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CountUntilGoal>)))
  ...
  "action_remote_teleop/CountUntilGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CountUntilGoal)))
  "Returns string type for a message object of type 'CountUntilGoal"
  "action_remote_teleop/CountUntilGoal")
